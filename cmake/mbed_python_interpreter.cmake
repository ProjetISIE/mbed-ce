...
set(MBED_CE_TOOLS_BASE_DIR "${MBED_SOURCE_DIR}/tools")
...
if(MBED_CREATE_PYTHON_VENV)
    ...
    string(FIND "${Python3_EXECUTABLE}" "${MBED_VENV_LOCATION}" MBED_PYTHON_IN_VENV)
    if(MBED_PYTHON_IN_VENV EQUAL 0 AND NOT Python3_FOUND)
    ...
    elseif(NOT EXISTS "${VENV_STAMP_FILE}")
        set(NEED_TO_CREATE_VENV TRUE)
        set(NEED_TO_INSTALL_PACKAGES TRUE)
    elseif(NOT (MBED_PYTHON_IN_VENV EQUAL 0))
